...
class GetDisneyListTreasureUseCaseTest{
    @get:Rule
    ...
    fun `WHEN invoke EXPECT return instance of List`() = runTest{
        coEvery { disneyRepository.getDisneyListTreasure() } returns TestDataListBuilder()
            .withNumElements(15)
            .buildList()

        val useCase = GetDisneyListTreasureUseCase(disneyRepository)
