...
class GetDisneyListHeroUseCaseTest{
    @get:Rule
    ...
    fun `WHEN invoke EXPECT return instance of List`() = runTest{
        coEvery { disneyRepository.getDisneyListHero() } returns TestDataListBuilder()
            .withNumElements(15)
            .buildList()

        val useCase = GetDisneyListHeroUseCase(disneyRepository)
